...
var Date_ = (function (_super) {
    ...
    Date_.PARSE_PATTERN = /^([0-9]{4})-([0-9]{2})-([0-9]{2})$/;
    return Date_;
}(DateBase));
exports.Date_ = Date_;
var Time = (function (_super) {
    ...
    Time.PARSE_PATTERN = /^([0-9]{2}):([0-9]{2})(:([0-9]{2})(\.([0-9]{1,3}))?)?$/;
    return Time;
}(DateBase));
exports.Time = Time;
var DateTime = (function (_super) {
    ...
    DateTime.PARSE_PATTERN = /([0-9]{4})-([0-9]{2})-([0-9]{2})T([0-9]{2}):([0-9]{2}):([0-9]{2})(.([0-9]{1,3}))?Z/;
    return DateTime;
}(DateBase));
exports.DateTime = DateTime;
var NestedSchemaField = (function (_super) {
    __extends(NestedSchemaField, _super);
    function NestedSchemaField(options) {
        var _this = _super.call(this, options) || this;
        _this.schema = options.schema;
        return _this;
    }
    NestedSchemaField.prototype.dump = function (val) {
        return this.schema.dump(val);
    };
    NestedSchemaField.prototype.load = function (val) {
        return this.schema.load(val);
    };
    return NestedSchemaField;
}(Base));
exports.NestedSchemaField = NestedSchemaField;
